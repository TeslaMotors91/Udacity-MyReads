...
class StarRatings extends Component {
  ...
  render() {
    ...
    const numOfStarsArray = Array(numOfStars)
      .fill()
      .map((_, i) => i + 1);
    ...
    var fillId = `starGrad${Math.random()
      .toFixed(15)
      .slice(2)}`;
    ...
    return (
      <div className="star-ratings" title={titleText} style={starRatingsStyle}>
...
StarRatings.defaultProps = {
  ...
  starSelectingHoverColor: 'rgb(50, 123, 53)',
